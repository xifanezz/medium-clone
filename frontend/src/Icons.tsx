...
export const Create = ({ size = 16, color = "currentColor" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const Error = ({ size = 16, color = "currentColor" }) => (
  <svg
...
export const Options = ({ size = 16, color = "currentColor", ...props }) => (
...
export const Save = ({ size = 16, color = "currentColor" ,...props}) => (
  <svg 
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    stroke= "currentColor"
...
export const Stop = ({ size = 16, color = "currentColor" , ...props}) => (
  <svg
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    stroke= "currentColor"
...
// currentColor is a defaulr attribute from svg
